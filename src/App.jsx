    ...
    <div className="flex flex-col gap-2 text-center mb-8">
        <div className="flex justify-center mb-4">
            <div className="p-3 rounded-xl bg-primary/5 border border-primary/10">
                <img src="/assets/logo.png" alt="Arxatec Logo" className="h-12 w-auto filter brightness-110" />
            </div>
        </div>
                    ...
                    <div className="pt-2 flex flex-col gap-4">
                        ...
                        <div className="relative my-2">
                            ...
                            <div className="relative flex justify-center text-xs">
                                <span className="bg-background px-2 text-muted-foreground tracking-widest">O ingresa con</span>
                            </div>
                        </div>
                        ...
                        <Button
                            variant="outline"
                            type="button"
                            onClick={() => window.location.href = "https://abogado.arxatec.net/api/auth/login/google"}
